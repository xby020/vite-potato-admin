...
declare global {
  ...
  const IconAkarIconsDesktopDevice: typeof import('~icons/akar-icons/desktop-device')['default']
  const IconBxError: typeof import('~icons/bx/error')['default']
  const IconBxMoon: typeof import('~icons/bx/moon')['default']
  const IconBxSun: typeof import('~icons/bx/sun')['default']
